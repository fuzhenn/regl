...
module.exports = function createTextureSet (
  ...
  function setImage (info, target, miplevel) {
    ...
    if (element) {
      ...
      // https://stackoverflow.com/questions/18430799/opengl-dxt-compressed-textures-black-when-width-height-differ
  ...
  function createTexture2D (a, b) {
    ...
    function texParameteri(key, value) {
      tempBind(texture)
      const reason = gl.texParameteri(GL_TEXTURE_2D, key, value)
      tempRestore()
      return reason
    }
