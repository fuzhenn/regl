...
module.exports = function (gl, extensions) {
  ...
  if (readFloat) {
    ...
    var internalFormat = gl2.getInternalFormat(gl, GL_RGBA, GL_FLOAT)
    gl.texImage2D(GL_TEXTURE_2D, 0, internalFormat, 1, 1, 0, GL_RGBA, GL_FLOAT, null)
