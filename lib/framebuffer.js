    ...
    function reglFramebuffer (a, b) {
      ...
      check(!depthStencilAttachment ||
        ...
        (depthStencilAttachment.renderbuffer &&
          (depthStencilAttachment.renderbuffer._renderbuffer.format === GL_DEPTH_STENCIL || depthStencilAttachment.renderbuffer._renderbuffer.format === GL_DEPTH24_STENCIL8)),
      ...
      updateFramebuffer(framebuffer, options.ignoreStatusCheck)
