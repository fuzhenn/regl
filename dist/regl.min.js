...
b){function c(a,b){var d,g=0,f=0,t=!0,k=!0;d=null;var m=!0,q="rgba",p="uint8",y=1,n=null,Q=null,pa=null,M=!1;if("number"===typeof a)g=a|0,f=b|0||g;else if(a){"shape"in a?(f=a.shape,g=f[0],f=f[1]):("radius"in a&&(g=f=a.radius),"width"in a&&(g=a.width),"height"in a&&(f=a.height));if("color"in a||"colors"in a)d=a.color||a.colors,Array.isArray(d);if(!d){"colorCount"in a&&(y=a.colorCount|0);"colorTexture"in a&&(m=!!a.colorTexture,q="rgba4");if("colorType"in a&&(p=a.colorType,!m))if("half float"===p||"float16"===
...
"float32");var H=0,M={};return K(t,{getFramebuffer:function(a){return"function"===typeof a&&"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof g)?a:null},create:Q,createCube:function(a){function b(a){var d,f={color:null},g=0,h=null;d="rgba";var t="uint8",l=1;if("number"===typeof a)g=a|0;else if(a){"shape"in a?g=a.shape[0]:("radius"in a&&(g=a.radius|0),"width"in a?g=a.width|0:"height"in a&&(g=a.height|0));if("color"in a||"colors"in a)h=a.color||a.colors,Array.isArray(h);h||("colorCount"in
...
var m=P(a,b),A=G(a,f),p=E(a,A,f),O=M(a,f),ja=y(a,f),l=H(a,f,m);g("viewport");g(h("scissor.box"));var n=0<Object.keys(ja).length,A={framebuffer:A,draw:O,shader:l,state:ja,dirty:n,scopeVAO:null,drawVAO:null,useVAO:!1,attributes:{}};A.profile=t(a,f);A.uniforms=U(d,f);A.drawVAO=A.scopeVAO=O.vao;if(!A.drawVAO&&l.program&&!m&&c.angle_instanced_arrays&&O["static"].elements){var q=!0;a=l.program.attributes.map(function(a){a=b["static"][a];q=q&&!!a;return a});if(q&&0<a.length){var r=k.getVAO(k.createVAO({attributes:a,
elements:O["static"].elements}));A.drawVAO=new J(null,null,null,function(a,b){return a.link(r)});A.useVAO=!0}}m?A.useVAO=!0:A.attributes=wa(b,f);A.context=B(e,f);return A}function ia(a,b,c){var d=a.shared.context,e=a.scope();Object.keys(c).forEach(function(f){b.save(d,"."+f);var g=c[f].append(a,b);Array.isArray(g)?e(d,".",f,"=[",g.join(),"];"):e(d,".",f,"=",g,";")});b(e)}function T(a,b,c,d){var e=a.shared,f=e.gl,g=e.framebuffer,h;Ma&&(h=b.def(e.extensions,".webgl_draw_buffers"));var k=a.constants,
...
E={elements:null,primitive:4,count:-1,offset:0,instances:-1},M=Yb(m,w),y=Jb(m,l,a,function(a){return L.destroyBuffer(a)}),U=Kb(m,w,y,l),L=Sb(m,w,M,l,y,U,E),B=Tb(m,q,l,a),C=Nb(m,w,M,function(){I.procs.poll()},H,l,a),P=Zb(m,w,M,l,a),T=Rb(m,w,M,C,P,l),I=Wb(m,q,w,M,y,U,C,T,{},L,B,E,H,t,a),q=Ub(m,T,I.procs.poll,H,g,w,M),R=I.next,N=m.canvas,F=[],S=[],V=[],Z=[a.onDestroy],ca=null;N&&(N.addEventListener("webglcontextlost",f,!1),N.addEventListener("webglcontextrestored",d,!1));var aa=T.setFBO=n({framebuffer:Y.define.call(null,
